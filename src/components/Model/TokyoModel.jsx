...
Author: edgarska (https://sketchfab.com/edgarska)
License: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
Source: https://sketchfab.com/3d-models/littlest-tokyo-sunsetnight-01da5a785d2e48a08f365546f0529338
Title: Littlest Tokyo: Sunset/Night
*/
"use client";
...
export default function TokyoModel(props) {
    const group = useRef();
    const { nodes, materials, animations } = useGLTF("/littlest_tokyo_sunsetnight.glb");
...
useGLTF.preload("/littlest_tokyo_sunsetnight.glb");
